...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WiredSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC10WiredSwift10Connection")
...
SWIFT_CLASS("_TtC10WiredSwift15BlockConnection")
@interface BlockConnection : Connection
@end
...
SWIFT_CLASS("_TtC10WiredSwift9P7Message")
@interface P7Message : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC10WiredSwift8P7Socket")
@interface P7Socket : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
/// \endcode@author Rafaël Warnault (mailto:rw@read-write.fr)
SWIFT_CLASS("_TtC10WiredSwift6P7Spec")
@interface P7Spec : NSObject <NSXMLParserDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC10WiredSwift10P7SpecItem")
@interface P7SpecItem : NSObject
...
SWIFT_CLASS("_TtC10WiredSwift11P7SpecError")
@interface P7SpecError : P7SpecItem
@end


SWIFT_CLASS("_TtC10WiredSwift11P7SpecField")
@interface P7SpecField : P7SpecItem
@end



SWIFT_CLASS("_TtC10WiredSwift13P7SpecMessage")
@interface P7SpecMessage : P7SpecItem
@end


SWIFT_CLASS("_TtC10WiredSwift3Url")
...
SWIFT_CLASS("_TtC10WiredSwift10WiredError")
@interface WiredError : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
